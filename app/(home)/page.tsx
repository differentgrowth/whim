        ...
        <div className="container grid items-center gap-4 px-4 text-center md:px-6">
          <div className="space-y-3">
            ...
            <p className={cn("mx-auto max-w-2xl", "text-muted-foreground")}>
              Transform long and cumbersome links into short, shareable URLs in
              a snap. Ideal for social media posts, emails, and more. Start
              simplifying your links now!
            </p>
      ...
      <section className="mx-auto w-full max-w-7xl py-12 md:py-24">
        ...
        >
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent>
              <CardDescription>
                Automate link validity with an expiration date feature, allowing
                links to become inactive after a specified period.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent>
              <CardDescription>
                Monitor link activity with a built-in usage counter, offering
                insights into how frequently your links are accessed.
              </CardDescription>
            </CardContent>
          </Card>
        </div>
